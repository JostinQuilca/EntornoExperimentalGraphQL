...
Requisitos: **Docker Desktop**, **k6** y **Python 3.10+**.

1. Clona este repositorio y entra a la carpeta.
2. `pip install -r requirements.txt`
3. Abre **Docker Desktop** y espera a que arranque.
4. Ejecuta `python preparar_entorno.py` y pulsa **«⚡ Preparar TODO (compu nueva)»**.
   Verifica prerequisitos, construye los contenedores y siembra los ~227 000 registros.
5. Al terminar, pulsa **«▶ Abrir Panel de Ataques»** y corre los casos UC-01 a UC-05.

Todo es **idempotente**: si algo ya está hecho, lo detecta y lo salta. También hay modo
consola: `python preparar_entorno.py --cli`.
